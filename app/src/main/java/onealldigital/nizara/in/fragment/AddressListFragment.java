...
public class AddressListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        processLyt = root.findViewById(R.id.processLyt1);
        ...
        if (getArguments().getString(Constant.FROM).equalsIgnoreCase("process")) {
            ...
            tvSubTotal.setText("Grand Total : "+session.getData(Constant.CURRENCY) + ApiConfig.StringFormat("" + getArguments().getDouble("total")));
