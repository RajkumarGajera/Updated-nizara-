...
import onealldigital.nizara.in.helper.AndroidMultiPartEntity;
...
//        fabProfile = root.findViewById(R.id.fabProfile);
        ...
        Picasso.get()
                ...
                .fit()
                .centerInside()
                .placeholder(R.drawable.profile_img_edit)
                .error(R.drawable.profile_img_edit)
    ...
    public void onPrepareOptionsMenu(@NonNull Menu menu) {
        ...
        menu.findItem(R.id.toolbar_notification).setVisible(false);
