...
import onealldigital.nizara.in.helper.GPSTracker;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnUpdateLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddressAddUpdateFragment.tvCurrent.setText(ApiConfig.getAddress(latitude, longitude, activity));
        ...
        fabCurrent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tvLocation.setText(getString(R.string.location_1) + ApiConfig.getAddress(latitude, longitude, activity));
            }
        });
        mapFragment.getMapAsync(mapReadyCallback);
        return root;
