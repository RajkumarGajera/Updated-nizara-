...
public class Seller {
    String id, name, store_name, email, mobile, balance, store_url, store_description, street, pincode_id, state, categories, account_number, bank_ifsc_code, bank_name, account_name, logo, national_identity_card, address_proof, pan_number, tax_name, tax_number, longitude, latitude, seller_address;
